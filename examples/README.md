...
```jsonc
{
  ...
  "sources": [
    {
      "chunk_id": "a3f8c2d1e9b047f6a2c5d8e1f3b4a7c9",  // SHA-256 of (accession + index)
      "ticker": "AAPL",
      "filing_date": "2024-11-01",
      "section": "Item 1A - Risk Factors",
      "relevance_score": 0.91,  // cosine similarity in [0, 1]; higher = more relevant
  ...
  "timing": {
    ...
    "retrieval_ms": 42.7,    // pgvector cosine similarity search over ~12 K chunks
